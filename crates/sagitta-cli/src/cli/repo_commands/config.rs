...
fn handle_set_repo_base_path(
    ...
    sagitta_search::config::save_config(config, override_path)?;
...
mod tests {
    use super::*;
    use tempfile::tempdir;
    use sagitta_search::config::{AppConfig, save_config, get_config_path_or_default, IndexingConfig, load_config};
    use crate::cli::CliArgs;
    use crate::cli::commands::Commands;
