...
pub struct ReasoningState {
    ...
    /// NEW: Task completion analyzer for focused analysis
    pub task_completion_analyzer: task_completion::TaskCompletionAnalyzer,
}
...
impl ReasoningState {
    ...
    pub fn new(original_request: String) -> Self {
        ...
        Self {
            ...
            task_completion_analyzer: task_completion::TaskCompletionAnalyzer::default(),
        }
    }
    ...
    fn validate_conversation_phase_transition(&self, old_phase: &ConversationPhase, new_phase: &ConversationPhase) -> Result<()> {
        ...
        if !valid_transition {
            return Err(ReasoningError::state(
...
/// Task completion analysis module - extracted from ReasoningState for better organization
