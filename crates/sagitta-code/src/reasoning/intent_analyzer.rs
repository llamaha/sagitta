...
impl IntentAnalyzer for SagittaCodeIntentAnalyzer {
    async fn analyze_intent(
        ...
        let has_continuation_indicators = text.contains("What would you like") ||
                                        ...
                                        // NEW: Detect specific follow-up questions generated by LLM
                                        text.contains("Should I") ||
                                        text.contains("Would you like me to analyze") ||
                                        text.contains("Would you like me to search") ||
                                        text.contains("Would you like me to explore") ||
                                        text.contains("Would you like me to investigate") ||
                                        text.contains("Should I continue") ||
                                        text.contains("Should I look into") ||
                                        text.contains("Would you prefer") ||
                                        (text.contains("?") && (text.contains("analyze") || text.contains("search") || text.contains("explore") || text.contains("investigate")));
