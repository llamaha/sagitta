...
".to_string()
        ...
        ToolDefinition {
            ...
            description: Some("Executes shell commands. ALWAYS specify at least ONE filter: head_lines (e.g. 20), tail_lines (e.g. 50), or grep_pattern (e.g. 'error'). Simple example: command='ls -la', head_lines=20. Leave working_directory empty to use current repo.".to_string()),
            input_schema: json!({
                "type": "object",
                "properties": {
