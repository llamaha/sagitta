...
// --- Placeholder Modules ---
/// Defines types related to embeddings and models.
pub mod types;
/// Provides traits and implementations for different embedding model providers.
pub mod provider;
...
impl EmbeddingHandler {
    ...
    ///
    /// If paths are changed, the existing ONNX provider (if any) will be cleared,
    /// and a new one will be lazily initialized on the next embedding operation or
    /// call to `create_embedding_model` or `get_onnx_provider`.
